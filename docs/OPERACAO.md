# Operação — Submarino DOMI

> Este é o manual completo de operação e o diário técnico do projeto: cada
> cena, cada tecla, cada decisão de áudio e de rede, e o que fazer quando algo
> estoura no meio da apresentação. A apresentação do projeto em si está no
